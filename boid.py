...
class boid:
    ...
    def _avoid_obstacles(self, obstacle, distance, x, y):
        ...
        self._avoidance_vector = [
            self._direction[0] + 0.1, self._direction[1] + 0.1]
    ...
    def _add_random_noise_to_direction(self):
        self._direction[0] = 0.99 * self._direction[0] + \
            random.choice((1, -1))*0.01*(random.random())
        self._direction[1] = 0.99 * self._direction[1] + \
            random.choice((1, -1))*0.01*(random.random())
    ...
    def _cohesion(self):
        ...
        self._cohesion_vector[0], self._cohesion_vector[1], k = self._set_direction_to_point(
            central_point, 10)
        return k
    ...
    def update_status(self):
        ...
        obstacle = True
        self._vector_to_target[0], self._vector_to_target[1], k1 = self._set_direction_to_point(
            boid._point_of_interest, 10)
        self._alignment()
        k2 = self._cohesion()
