...
class boid:
    ...
    def update_status(self):
        ...
        # self._direction = [(self._vector_to_target[0] + self._cohesion_vector[0])/2,(self._vector_to_target[1] + self._cohesion_vector[1])/2 ]
        self._direction  = self._cohesion_vector
